...
public class CurrentVoltageTraceCanvasPart extends TraceCanvasPart
{
	...
	{
		super("Current-voltage average trace", "Current", "A", "Voltage", "V", CurrentVoltageTraceCanvasPart.class.getClassLoader().getResource("icons/parts/scatter.png"), true, true, frame, window, average, 0);
	}
