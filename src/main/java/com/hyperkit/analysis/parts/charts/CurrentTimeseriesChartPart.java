...
public class CurrentTimeseriesChartPart extends ChartPart
{
	...
	public CurrentTimeseriesChartPart(int step)
	{
	...
	protected JFreeChart createChart()
	{
		...
		return ChartFactory.createXYLineChart("Current timeseries", "Time", "Current", dataset, PlotOrientation.VERTICAL, true, true, true);
	}
